...
const baseQuery = "SELECT ee.* FROM entidades ee WHERE ee.identi = :identi";
const insertSql = "BEGIN INCENTIVOS_PKG.INSERTENTIDAD(:fecent,:letnif,:nifent,:desent,:adment,:obsent,:staent,:status,:usumov,:tipmov,:idusua); END;";
const updateSql = "BEGIN INCENTIVOS_PKG.UPDATEENTIDAD(:identi,:fecent,:letnif,:nifent,:desent,:adment,:obsent,:staent,:status,:usumov,:tipmov); END;";
